...
<html lang="es"  class="supernova"><head><script>console.warn("Server Side Rendering => render-from: frontend");</script>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F222833629063861" title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F222833629063861" title="oEmbed Form">
<meta property="og:title" content="Formato de inscripción " >
<meta property="og:url" content="https://form.jotform.com/222833629063861" >
...
<link href="https://cdn01.jotfor.ms/static/formCss.css?3.3.36355" rel="stylesheet" type="text/css" />
...
<script defer src="https://cdn02.jotfor.ms/js/vendor/maskedinput.min.js?v=3.3.36355" type="text/javascript"></script>
<script defer src="https://cdn03.jotfor.ms/js/vendor/jquery.maskedinput.min.js?v=3.3.36355" type="text/javascript"></script>
...
if (window.JotForm && JotForm.accessible) $('input_54').setAttribute('tabindex',0);
 ...
 for(var langIndex = 0; langIndex < languageOptions.length; langIndex++) { 
   languageOptions[langIndex].on('click', function(e) { setTimeout(function(){ JotForm.setCalendar("50", false, {"days":{"monday":true,"tuesday":true,"wednesday":true,"thursday":true,"friday":true,"saturday":true,"sunday":true},"future":false,"past":false,"custom":false,"ranges":false,"start":"","end":""}); }, 0); });
 } 
...
<form class="jotform-form" action="https://submit.jotform.com/submit/222833629063861/" method="post" name="form_222833629063861" id="222833629063861" accept-charset="utf-8" autocomplete="on">
  ...
  <div role="main" class="form-all">
    <link type="text/css" rel="stylesheet" media="all" href="https://cdn.jotfor.ms/wizards/languageWizard/custom-dropdown/css/lang-dd.css?3.3.36355" />
    <div class="cont">
    ...
    <script type="text/javascript" src="https://cdn.jotfor.ms/js/formTranslation.v2.js?3.3.36355"></script>
    <ul class="form-section page-section">
      <li class="form-line" data-type="control_image" id="id_47">
        <div id="cid_47" class="form-input-wide">
          <div style="text-align:center">
            <img class="form-image" src="https://utp.ac.pa/documentos/2015/imagen/logo_utp_1_300.png" height="310px" width="520px"/>
          </div>
        </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-2 jf-required" data-type="control_dropdown" id="id_48">
        <label class="form-label form-label-top" id="die" for="die">
          Es miembro de IEEE
          <span class="form-required">
            *
          </span>
      ...
      <li class="form-line form-line-column form-col-3 jf-required" data-type="control_dropdown" id="id_49">
          ...
          <div summary="" class="form-address-table jsTest-addressField">
            ...
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-zip-line jsTest-address-lineField form-address-hiddenLine" >
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="UDF" placeholder="Unidad/Departamento/Facultad" name="UDF" class="form-textbox form-address-postal" data-defaultvalue="" autoComplete="section-input_56 postal-code" value="" data-component="zip" aria-labelledby="label_56 sublabel_56_postal" />
                  <label class="form-sub-label" for="input_56_postal" id="sublabel_56_postal" style="min-height:13px" aria-hidden="false"> Unidad/Departamento/Facultad </label>
                </span>
              </span>
  ...
  Total <input type="text"  class="form-control item" name="total" id="total" onChange="calcular()" readonly/><br>
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_phone" id="id_53">
        ...
        <li class="form-line" data-type="control_button" id="id_83">
          <div id="cid_83" class="form-input-wide">
            <div style="margin-left:156px" data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField">
              <button id="input_83" type="submit" class="form-submit-button submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">
                Enviar
              </button>
...
<button class="form-submit-button submit-button jf-form-buttons jsTest-submitField" type="reset" value="Limpiar">Limpiar</button>
            </div>
          </div>
        </li>
        <li style="clear:both">
...
for (var i = 0; i < all_spc.length; i++)
{
  ...
  <div class="formFooter f6 branding21">
    <div class="formFooter-wrapper formFooter-leftSide">
      <a href="" target="_blank" class="formFooter-logoLink"><img class="formFooter-logo" src="" alt="UTP logo" style="height: 44px;"></a>
    </div>
