            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="?op=permitido">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="public/images/utp.svg" alt="homepage" width="50" height="50" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="public/images/logo-text.png" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <a class="profile-pic" href="#">
                                <!-- <img src="public/images/users/<?php //echo $_SESSION["foto"]; ?>" alt="user-img" width="36"
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="?op=perfil"
                                aria-expanded="false">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="?op=permitido" class="fw-normal">Dashboard</a></li>
                            </ol>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="public/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                       <!-- <a href="javascript:void(0)"><img src="public/images/users/<?php //echo $_SESSION["foto"]; ?>"
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" name="formulario" method="POST" action="./?ops=actualizar" enctype="multipart/form-data">
